...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2023 at 11:23 AM
...
--
-- Table structure for table `online_exam_message`
--

CREATE TABLE `online_exam_message` (
  `id` int(100) NOT NULL,
  `name` varchar(500) NOT NULL,
  `email` varchar(100) NOT NULL,
  `message` longtext NOT NULL,
  `time` varchar(200) NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `online_exam_message`
--

INSERT INTO `online_exam_message` (`id`, `name`, `email`, `message`, `time`) VALUES
(1, 'lintang', 'lintang@mail.com', 'semangat pemwebnya', 'current_timestamp()'),
(2, 'Lintang Iqhtiar Dwi Mawarni', 'lintangiqhtiar@gmail.com', 'perlu pengembangan lebih lanjut', '2023-05-19 16:06:08'),
(3, 'Lintang Iqhtiar Dwi Mawarni', 'lintangiqhtiar@gmail.com', 'perlu pengembangan lebih lanjut', '2023-05-19 16:08:03'),
(4, 'Lintang Iqhtiar Dwi Mawarni', 'lintangiqhtiar@gmail.com', 'perlu pengembangan lebih lanjut', '2023-05-19 16:09:19');
...
(33, 4, 3, '2023-05-16 12:11:53'),
(34, 4, 7, '2023-05-16 12:14:17');
...
INSERT INTO `online_exam_user` (`id`, `first_name`, `last_name`, `gender`, `email`, `password`, `mobile`, `created`, `role`) VALUES
...
(6, 'sfas', 'khan', 'Male', 'abcd@gmail.com', '202cb962ac59075b964b07152d234b70', '1234567890', '2021-11-04 20:42:14', 'user'),
(9, 'Lintang', 'Iqhtiar', 'Female', 'lintang@mail.com', '$2y$10$nrakVfGcjMLYf6bP0aZEF.Z.emt21/VO9p8Hx/wg.Yc42GknSnL0W', '0980797', '2023-05-17 18:08:27', 'user'),
(10, 'baba', 'ala', 'Male', 'bala@mail.com', '678', '9898', '2023-05-17 18:53:08', 'user'),
(11, 'nana', 'bab', '', 'mama@jh.com', '090', 'ah', '2023-05-17 22:02:36', 'user'),
(12, 'aka', 's', '', 'aba@kom.com', '000', 'd', '2023-05-17 22:04:32', 'user'),
(13, 'wilda', 'c', '', 'wilda@mail.com', '123', '77867', '2023-05-19 12:27:24', 'user');
...
--
-- Indexes for table `online_exam_message`
--
ALTER TABLE `online_exam_message`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `online_exam_message`
--
ALTER TABLE `online_exam_message`
